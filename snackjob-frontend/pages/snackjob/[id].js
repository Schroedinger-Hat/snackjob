            ...
            <Box px={8} py={5} mx="auto">
                ...
                >
                    ...
                    <Button
                        ...
                        onClick={(e) => {
                            e.preventDefault()
                            const width = parseInt(window.document.querySelector('#bsvg').getAttribute('width'))
                            const height = parseInt(window.document.querySelector('#bsvg').getAttribute('height'))
